...
class ViewConfig: UIViewController {

    func configMenu(view: UIView) {
        ...
        changeMapBut.layer.position = CGPoint(x: screenWidth * 0.5, y: screenHeight * 0.5)
        changeMapBut.backgroundColor = UIColor.redColor()
        
        configView.addSubview(changeMapBut)
