...
public struct GPX: Codable, DynamicNodeEncoding  {
    ...
    public var extensions: WorkoutExtension? // (Element)
    ...
    public struct WptType: Codable ,DynamicNodeEncoding{  // (ComplexType)
        ...
        /// You can add extend GPX by adding your own elements from another schema here.
        public var extensions: TrackPointExtension? // (Element)
    ...
    public struct CopyrightType: Codable ,DynamicNodeEncoding {  // (ComplexType)
    ...
    public struct LinkType: Codable ,DynamicNodeEncoding {  // (ComplexType)
    ...
    public struct PtType: Codable , DynamicNodeEncoding{  // (ComplexType)
    ...
    public struct TrackPointExtension: Codable {  // (ComplexType)

        public var speed: Double? // (Attibute)

        public var course: Double? // (Attibute)

        public var hAcc: Double? // (Attibute)

        public var vAcc: Double? // (Attibute)
        
        public var heartRate: Double? // (Attibute)
        
        
    }
    public struct WorkoutExtension: Codable {  // (ComplexType)


        public var totalDistance: Double? // (Attibute)
        
        public var totalEnergyBurned: Double? // (Attibute)
        
        public var duration: Double? // (Attibute)
        
        public var workoutActivityType: Int? // (Attibute)
        
        public var sdate: String? // (Attibute)
        
        public var edate: String? // (Attibute)
        
        public var device: String? // (Attibute)

        public var uuid: String? // (Attibute)
